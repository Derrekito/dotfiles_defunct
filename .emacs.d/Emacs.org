...
#+begin_src emacs-lisp
  ...
  (defvar efs/default-org-block-font-size 140)
  (defvar efs/default-org-code-font-size 140)
  (defvar efs/default-org-table-font-size 120)
...
#+begin_src emacs-lisp
  ...
  (defun efs/org-font-setup ()
    ...
    (set-face-attribute 'org-block nil :font "Fira Code Retina" :height efs/default-org-block-font-size)
    (set-face-attribute 'org-table nil :font "Fira Code Retina" :height efs/default-org-table-font-size)
    (set-face-attribute 'org-code nil :font "Fira Code Retina" :height efs/default-org-code-font-size)
    )
#+end_src
...
#+begin_src emacs-lisp
  ...
  (defun my-org-confirm-babel-evaluate (lang body)
    (not (string= lang "jupyter-python")))  ;don't ask for jupyter-python
...
#+begin_src emacs-lisp
  ...
  (add-hook 'python-mode-hook
            (lambda () (setq python-indent-offset 8)))
